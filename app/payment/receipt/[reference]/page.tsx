...
export default function PaymentReceipt() {
  ...
  const qrData = JSON.stringify({
    ...
    student: {
      ...
      matric: receipt.student.matric_number,
      level: receipt.student.level,
    },
    payment: {
      amount: receipt.payment.amount,
      date: receipt.payment.payment_date,
      session: receipt.payment.academic_session,
      fee_type: receipt.payment.fee_type,
    },
    verification: `FPB-RECEIPT-${receipt.payment.id}`,
                ...
                <div className="flex items-start gap-6">
                  ...
                  <div className="flex-shrink-0">
                    <div className="bg-white p-3 border-2 border-blue-400 rounded-lg">
                      <QRCodeGenerator data={qrData} size={120} />
                    </div>
